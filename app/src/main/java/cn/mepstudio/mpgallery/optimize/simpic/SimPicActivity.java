package cn.mepstudio.mpgallery.optimize.simpic;
...
public class SimPicActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.optimize_activity_simpic);
        ...
        headerView = LayoutInflater.from(SimPicActivity.this).inflate(R.layout.optimize_layout_similar_header, null);
