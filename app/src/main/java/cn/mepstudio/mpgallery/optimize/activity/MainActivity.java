package cn.mepstudio.mpgallery.optimize.activity;
...
import cn.mepstudio.mpgallery.optimize.BitmapBO;
import cn.mepstudio.mpgallery.optimize.GridViewAdapter;
import cn.mepstudio.mpgallery.optimize.album.AlbumsActivity;
import cn.mepstudio.mpgallery.optimize.blurry.BlurryPictureActivity;
import cn.mepstudio.mpgallery.optimize.blurry.BlurryPictureUtil;
import cn.mepstudio.mpgallery.optimize.recycle.JunkPictureUtil;
import cn.mepstudio.mpgallery.optimize.recycle.RecyclerPictureActivity;
import cn.mepstudio.mpgallery.optimize.simpic.JunkSimUtil;
import cn.mepstudio.mpgallery.optimize.simpic.SimPicActivity;
import cn.mepstudio.mpgallery.optimize.simpic.SimPicUtil;
import cn.mepstudio.mpgallery.optimize.simpic.SimilarPicBO;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSimSize = findViewById(R.id.tv_header_size);
        tvBlurrySize = findViewById(R.id.tv_blurry_size);
        tvAllSize =  findViewById(R.id.tv_all_size);
        tvRecyclerSize =  findViewById(R.id.tv_recycler_size);
        rlSim =  findViewById(R.id.rl_simpic);
        rlAblum =  findViewById(R.id.rl_album);
        rlRecycler = findViewById(R.id.rl_recycler);
        rlBlurry =  findViewById(R.id.rl_blurry);

        gvSim =  findViewById(R.id.gv_sim_pic);
        gvBlurry =  findViewById(R.id.gv_blurry_pic);
...
//找模糊照片
    ...
    protected void onDestroy() {
        super.onDestroy();
        System.out.println("CompressActivity===onDestroy=");
        if (junkSimUtil != null) {
            junkSimUtil.destory();
        }
    }
