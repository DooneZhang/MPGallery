package cn.mepstudio.mpgallery.optimize.blurry;
...
import cn.mepstudio.mpgallery.optimize.simpic.SimpicAdapter;
...
public class BlurryPictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.optimize_activity_blurry_pic);
        lvPic =  findViewById(R.id.lv_pic);
