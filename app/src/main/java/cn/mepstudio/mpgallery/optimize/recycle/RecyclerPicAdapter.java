package cn.mepstudio.mpgallery.optimize.recycle;
...
import cn.mepstudio.mpgallery.optimize.ImageUtil;
import cn.mepstudio.mpgallery.R;
import cn.mepstudio.mpgallery.optimize.album.PhotoUpImageItem;
...
public class RecyclerPicAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Holder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.optimize_images_item_view, parent, false);
            holder = new Holder();
