package com.beiing.gifmaker.widgets.roundimageview;
...
public class HoverImageView extends ImageView{
	...
	private void setup(AttributeSet attrs) {
		if(attrs != null){
			...
			borderColor = typedArray.getColor(R.styleable.RoundImageView_edgeColor, borderColor);
			hoverColor = typedArray.getColor(R.styleable.RoundImageView_hoverColor, hoverColor);
			borderWidth = typedArray.getDimension(R.styleable.RoundImageView_edgeWidth, borderWidth);
			typedArray.recycle();
		}
